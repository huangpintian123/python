...
Bgcolor = (25, 25, 112)  #midnight blue
pygame.init()
screen = pygame.display.set_mode([800, 600])
pygame.display.set_caption("stars everywhere")
mousedown = False
keep_going = True
clock = pygame.time.Clock()
pic = pygame.image.load("/Users/huangpintian/Desktop/little bubble/paopao.png")
...
while keep_going:
    ...
    if mousedown:
        ...
        NewStar = Star(pygame.mouse.get_pos(),speedx,speedy)
        sprite_list.add(NewStar)
